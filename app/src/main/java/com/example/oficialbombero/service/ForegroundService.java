...
public class ForegroundService extends Service {
    ...
    public final String CHANNEL_ID = "com.example.oficialbombero";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification notification = new NotificationCompat.Builder(this, CHANNEL_ID)
                .setSmallIcon(R.drawable.ic_car).setContentTitle("Emergencia en curso")
    ...
    private void startMyForegroundService() {
        ...
        Notification notification = builder
                ...
                .setContentTitle("Emergencia en curso")
                .setContentText("App corriendo en segundo plano")
                .setPriority(NotificationManager.IMPORTANCE_HIGH)
                .setCategory(Notification.CATEGORY_SERVICE)
                .build();
