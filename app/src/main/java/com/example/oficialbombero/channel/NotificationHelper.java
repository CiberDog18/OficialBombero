package com.example.oficialbombero.channel;
...
public class NotificationHelper extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.example.oficialbombero";
    private static final String CHANNEL_NAME = "OficialBombero";
